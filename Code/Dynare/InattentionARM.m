...
M_.endo_names_tex = char(M_.endo_names_tex, 'pi\_w\_ann');
M_.endo_names_long = char(M_.endo_names_long, 'pi_w_ann');
...
options_.irf = 200;
options_.order = 1;
var_list_ = char('y_gap','pi_p_ann','i_ann','r_real_ann','nu','c_R','c_K','max_real_debt','real_debt','w_gap','n_K');
